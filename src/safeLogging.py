...
class SafeFileHandler(logging.FileHandler):
    def __init__(self, filename, mode, encoding=None, delay=0):
        ...
        self.suffix_time = ""
        self.delay = delay
        self.prefix_filename = self.baseFilename
    ...
    def build_baseFilename(self):
        ...
        if self.suffix_time != "":
            ...
            self.baseFilename = self.prefix_filename
...
class SafeBaseRotatingHandler(SafeFileHandler):
    """
...
class SafeTimedRotatingFileHandler(SafeBaseRotatingHandler):
    """
    ...
    def __init__(self, filename, when='h', interval=1, backupCount=0, encoding=None, delay=False, utc=False):
        SafeBaseRotatingHandler.__init__(self, filename, 'a', encoding, delay)
